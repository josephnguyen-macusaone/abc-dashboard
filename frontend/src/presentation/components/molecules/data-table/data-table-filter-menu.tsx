...
import { DataTableRangeFilter } from "@/presentation/components/molecules/data-table/data-table-range-filter";
      ...
      >
        ...
        >
          <SelectTrigger
            ...
            className="h-8 rounded-none border-r-0 px-2.5 lowercase [&_svg]:hidden"
          >
